...
## Corpus Check
- 193 files · ~156,994 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2733 nodes · 2632 edges · 223 communities (216 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `632250ba`
...
### Community 147 - "1. 自律コーディングエージェントの主要実装例"
Cohesion: 0.25
...
### Community 164 - "4. 限界と課題(現実の到達点の裏面)"
Cohesion: 0.29
...
## Knowledge Gaps
- **2075 isolated node(s):** `normalized`, `res`, `ADR-0006`, `ADR-0017`, `ADR-0020` (+2070 more)
