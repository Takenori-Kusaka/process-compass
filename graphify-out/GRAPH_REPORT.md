...
## Corpus Check
- 224 files · ~170,172 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3166 nodes · 3047 edges · 262 communities (256 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f7d0aae0`
...
1. `scripts` - 17 edges
2. `Process Compass` - 17 edges
3. `118/119 一次調査: スタック型 PR と AI 協調タスク管理・レビュー SLA` - 15 edges
4. `調査メモ: AI自律レベルの動的境界と開発者役割の移行（Issue #109 / #110）` - 14 edges
5. `調査メモ: AI 維持管理責任者（AI Maintainer）と AI 運用担当者（AIOps）の職掌（Issue #111 / #112）` - 14 edges
6. `調査メモ: Seeded Errors による自動化バイアス検知と、承認権限の一時制限・例外決裁（Issue #113 / #114）` - 14 edges
7. `調査メモ: 三識メトリクス・ダッシュボードとKPT改善サイクルの制度化（Issue #116 / #117）` - 14 edges
8. `Issue #120 一次調査メモ: 出荷判定ゲート・契約書に適用する AI SLA ガバナンス評価規程` - 14 edges
9. `調査メモ: ISO 12100 準拠 AIソフトウェア・リスクアセスメント成果物テンプレート（Issue #122）` - 14 edges
...
### Community 3 - "scripts"
Cohesion: 0.04
Nodes (45): astro, astro-mermaid, @astrojs/sitemap, @astrojs/starlight, mermaid, dependencies, astro, astro-mermaid (+37 more)
...
### Community 146 - "3. アンチパターン各論(本メモの中心)"
Cohesion: 0.29
...
## Knowledge Gaps
- **2405 isolated node(s):** `normalized`, `repoRoot`, `relative`, `res`, `ADR-0006` (+2400 more)
