...
## Corpus Check
- 141 files · ~93,528 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1371 nodes · 1285 edges · 125 communities (113 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `891c32c8`
...
### Community 14 - "ウォーターフォール開発プロセス 調査メモ"
Cohesion: 0.04
Nodes (37): 0. プロセスの概要, 10. 出典一覧, 1. title / purpose / outcomes, 2. 階層構造(process → activities → tasks), 3. roles(ロール), 4. information items(成果物・文書), 5. gates(ゲート・決裁), 6. レビュープロセス (+29 more)
...
### Community 103 - "🛠️ カテゴリ3: 自動化バイアス・形骸化防止＆メトリクス（ノード9）"
Cohesion: 0.10
...
### Community 104 - "block2_research.md"
Cohesion: 0.13
...
Cohesion: 0.25
Nodes (7): 7.1 本章が達成すべき成果, 7.2 例外の前提, 7.3 例外承認の要求事項, 7.4 判定の滞留に対する措置, 7.5 エスカレーションの基準, 7.6 記録の要求事項, 7.7 関連する章
...
### Community 118 - "block3_research.md"
Cohesion: 0.17
...
### Community 119 - "2. 議論から得られた5つの核心的設計方針（To-Be）"
Cohesion: 0.17
...
## Knowledge Gaps
- **1013 isolated node(s):** `normalized`, `res`, `ADR-0006`, `name`, `type` (+1008 more)
...
- **Why does `エージェント型開発(自律・マルチエージェント)の現在地 調査メモ` connect `エージェント型開発(自律・マルチエージェント)の現在地 調査メモ` to `ウォーターフォール開発プロセス 調査メモ`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `日本企業のガバナンス・決裁ゲートの実態 調査メモ` connect `日本企業のガバナンス・決裁ゲートの実態 調査メモ` to `ウォーターフォール開発プロセス 調査メモ`?**
