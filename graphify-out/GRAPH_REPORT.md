...
## Corpus Check
- 117 files · ~84,387 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1095 nodes · 1033 edges · 101 communities (94 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a18f792b`
...
## Knowledge Gaps
- **820 isolated node(s):** `normalized`, `res`, `ADR-0006`, `name`, `type` (+815 more)
...
- **Why does `プロダクトオーナー中心のチーム編成論 調査メモ` connect `プロダクトオーナー中心のチーム編成論 調査メモ` to `スクラム(Scrum)調査メモ`?**
