...
## Corpus Check
- 217 files · ~167,339 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3061 nodes · 2945 edges · 256 communities (250 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2f5cd4d9`
...
### Community 146 - "1. 理想像の出所(建前=そう語られる)"
Cohesion: 0.50
...
### Community 173 - "4. 組織論的な論点(従来編成 vs PO中心編成)"
Cohesion: 0.50
...
## Knowledge Gaps
- **2327 isolated node(s):** `normalized`, `repoRoot`, `relative`, `res`, `ADR-0006` (+2322 more)
...
- **Why does `エージェント型開発の現在地 更新調査メモ(2026-08-04 時点)` connect `エージェント型開発の現在地 更新調査メモ(2026-08-04 時点)` to `20260710-jp-governance.md`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `プロダクトオーナー中心のチーム編成論 調査メモ` connect `プロダクトオーナー中心のチーム編成論 調査メモ` to `9. 出典一覧`, `20260710-jp-governance.md`, `1. 理想像の出所(建前=そう語られる)`, `4. 組織論的な論点(従来編成 vs PO中心編成)`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
