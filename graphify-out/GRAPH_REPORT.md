...
## Corpus Check
- 299 files · ~253,498 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3814 nodes · 3732 edges · 330 communities (322 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6fbaa9af`
...
Cohesion: 0.12
Nodes (17): 0. このメモの全体像, 1.1 一次定義(Anthropic), 1.2 プロンプトエンジニアリングとの違い(建前上の切り分け), 1. 定義:コンテキストエンジニアリングとは何か, 3.1 ポランニー:暗黙知の原典, 3.2 野中の SECI モデル:暗黙知⇄形式知の変換サイクル, 3.3 CE 手法と SECI プロセスの対応(本メモの統合。→ 考察扱い), 3. 暗黙知の形式知化という観点(SECI / ポランニー) (+9 more)
...
### Community 281 - "2. 主要手法:コンテキストの層としての整理"
Cohesion: 0.22
...
### Community 282 - "ProcessActivity.astro"
Cohesion: 0.22
...
Cohesion: 0.29
Nodes (6): 何を追跡するか, 書式, 運用, 降りていない規定の扱い, 降ろし先の登録簿, 限界
...
### Community 317 - "comparison.astro"
Cohesion: 0.40
...
### Community 321 - "複製したファイル"
Cohesion: 0.40
Nodes (4): なぜ複製するのか, 乖離の検出, 更新の手順, 複製したファイル

### Community 322 - "8. 出典一覧"
Cohesion: 0.50
...
### Community 324 - "案件層コンテキスト"
Cohesion: 0.50
Nodes (3): 恒久層へ上げるもの, 書くこと, 案件層コンテキスト

### Community 325 - "ブランチ保護"
Cohesion: 0.50
...
### Community 327 - "articles/README.md"
Cohesion: 0.50
...
## Knowledge Gaps
- **2874 isolated node(s):** `normalized`, `repoRoot`, `relative`, `res`, `ADR-0006` (+2869 more)
...
- **Why does `コンテキストエンジニアリング手法 調査メモ` connect `コンテキストエンジニアリング手法 調査メモ` to `20260710-jp-governance.md`, `8. 出典一覧`, `2. 主要手法:コンテキストの層としての整理`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
