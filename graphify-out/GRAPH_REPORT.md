...
## Corpus Check
- 214 files · ~165,910 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3027 nodes · 2911 edges · 253 communities (248 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `84e44cdc`
...
## Communities (253 total, 5 thin omitted)
...
## Knowledge Gaps
- **2303 isolated node(s):** `normalized`, `repoRoot`, `relative`, `res`, `ADR-0006` (+2298 more)
