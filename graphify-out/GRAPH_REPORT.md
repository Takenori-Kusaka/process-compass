...
## Corpus Check
- 217 files · ~167,410 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3062 nodes · 2946 edges · 254 communities (248 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `43dadbf6`
...
## Communities (254 total, 6 thin omitted)
...
## Knowledge Gaps
- **2328 isolated node(s):** `normalized`, `repoRoot`, `relative`, `res`, `ADR-0006` (+2323 more)
