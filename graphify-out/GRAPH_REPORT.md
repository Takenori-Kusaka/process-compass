...
## Corpus Check
- 302 files · ~255,232 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3870 nodes · 3785 edges · 332 communities (324 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f415ede`
...
### Community 3 - "scripts"
Cohesion: 0.13
Nodes (15): scripts, astro, build, check, dev, evidence:write, impl:write, lint:evidence (+7 more)
...
Cohesion: 0.12
Nodes (16): Claude Code 設定(.claude/), Git 戦略, graphify, Process Compass, Zenn 発信(submodule), コマンド, プロジェクト構造, プロジェクト運営(Issue 駆動) (+8 more)
...
### Community 232 - "getting-started.md"
Cohesion: 0.12
...
### Community 233 - "solo-developer.md"
Cohesion: 0.12
...
### Community 237 - "build-template-kb.mjs"
Cohesion: 0.18
Nodes (12): yaml, args, buildKb(), gateAnchors(), loadRules(), loadYaml(), ADR-0035, PROCESS_FILE (+4 more)
...
### Community 243 - "accuracy-as-commodity.md"
Cohesion: 0.14
...
### Community 257 - "formatting-intelligence.md"
Cohesion: 0.15
...
### Community 258 - "local-first-privacy.md"
Cohesion: 0.15
...
### Community 259 - "physical-trigger.md"
Cohesion: 0.15
...
### Community 267 - "vault-data-design.md"
Cohesion: 0.17
...
### Community 274 - "dependency-diff.mjs"
Cohesion: 0.20
Nodes (7): base, changed, MANIFESTS, md, out, result, touched

### Community 275 - "D-0 意思決定・エスカレーション体制図"
Cohesion: 0.20
...
### Community 281 - "evaluating-formatting-intelligence.md"
Cohesion: 0.20
...
### Community 283 - "speed-floor-gpu-vulkan.md"
Cohesion: 0.20
...
### Community 284 - "2. 主要手法:コンテキストの層としての整理"
Cohesion: 0.22
...
### Community 291 - "default-model-reversal.md"
Cohesion: 0.22
...
### Community 301 - "AIエージェント安全リスクアセスメント"
Cohesion: 0.25
Nodes (8): AIエージェント安全リスクアセスメント, リスク低減の3ステップ, 分析手法, 危険源の同定, 手順, 本節の位置づけ, 記号体系, 適用条件
...
### Community 304 - "vendor/tailoring-engine.mjs"
Cohesion: 0.43
...
### Community 326 - "案件層コンテキスト"
Cohesion: 0.50
Nodes (3): 恒久層へ上げるもの, 書くこと, 案件層コンテキスト

### Community 327 - "ブランチ保護"
Cohesion: 0.50
...
### Community 330 - "articles/README.md"
Cohesion: 0.50
...
## Knowledge Gaps
- **2918 isolated node(s):** `normalized`, `repoRoot`, `relative`, `res`, `ADR-0006` (+2913 more)
...
- **Why does `コンテキストエンジニアリング手法 調査メモ` connect `コンテキストエンジニアリング手法 調査メモ` to `20260710-jp-governance.md`, `2. 主要手法:コンテキストの層としての整理`, `4. 限界`?**
