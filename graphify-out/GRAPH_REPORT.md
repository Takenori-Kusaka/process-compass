...
## Corpus Check
- 220 files · ~168,799 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3114 nodes · 2995 edges · 262 communities (255 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d770e6bf`
...
### Community 205 - "7. ハイコンテキスト文化(明文化を阻む土台)"
Cohesion: 0.50
...
## Knowledge Gaps
- **2368 isolated node(s):** `normalized`, `repoRoot`, `relative`, `res`, `ADR-0006` (+2363 more)
