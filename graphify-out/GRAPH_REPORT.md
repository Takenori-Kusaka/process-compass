...
## Corpus Check
- 186 files · ~149,338 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2571 nodes · 2475 edges · 215 communities (209 shown, 6 thin omitted)
...
## Knowledge Gaps
- **1951 isolated node(s):** `normalized`, `res`, `ADR-0006`, `ADR-0017`, `ADR-0020` (+1946 more)
