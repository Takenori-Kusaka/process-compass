...
## Corpus Check
- 196 files · ~158,479 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2783 nodes · 2679 edges · 234 communities (227 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4dd467c4`
...
Cohesion: 0.15
Nodes (13): 0. このメモの全体像, 1.1 一次定義(Anthropic), 1.2 プロンプトエンジニアリングとの違い(建前上の切り分け), 1. 定義:コンテキストエンジニアリングとは何か, 4.1 コンテキストウィンドウの有限性, 4.2 Context Rot(長い文脈での劣化), 4.3 ポランニーの逆説(原理的・言語化不能の限界), 4.4 明文化コスト(組織的コスト) (+5 more)
...
### Community 164 - "2. 主要手法:コンテキストの層としての整理"
Cohesion: 0.22
...
### Community 165 - "3. アンチパターン各論(本メモの中心)"
Cohesion: 0.29
...
## Knowledge Gaps
- **2115 isolated node(s):** `normalized`, `res`, `ADR-0006`, `ADR-0017`, `ADR-0020` (+2110 more)
