...
## Corpus Check
- 160 files · ~127,535 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2105 nodes · 2000 edges · 177 communities (165 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68cc09c4`
...
### Community 127 - "第2部: GitHub Issueドラフト（計12件）"
Cohesion: 0.06
...
### Community 128 - "第1部: 根本課題の構造的整理 (14の論点ノード)"
Cohesion: 0.08
...
### Community 135 - "第2部: GitHub Issueドラフト（計9件）"
Cohesion: 0.09
...
### Community 160 - "🛠️ カテゴリ3: 自動化バイアス・形骸化防止＆メトリクス（ノード9）"
Cohesion: 0.10
...
### Community 161 - "block2_research.md"
Cohesion: 0.13
...
### Community 162 - "block3_research.md"
Cohesion: 0.17
...
### Community 165 - "2. 議論から得られた5つの核心的設計方針（To-Be）"
Cohesion: 0.17
...
### Community 171 - "5. 「人間の検証帯域が律速」— 定量証拠が出そろった"
Cohesion: 0.50
...
## Knowledge Gaps
- **1579 isolated node(s):** `normalized`, `res`, `ADR-0006`, `name`, `type` (+1574 more)
...
- **Why does `エージェント型開発の現在地 更新調査メモ(2026-08-04 時点)` connect `エージェント型開発の現在地 更新調査メモ(2026-08-04 時点)` to `20260710-jp-governance.md`, `1. 主要エージェント製品の現況`, `2. ベンチマークの最新値`, `4. マルチエージェントのトレンド — 「制約された協調+人間の統制」は妥当か`, `5. 「人間の検証帯域が律速」— 定量証拠が出そろった`?**
