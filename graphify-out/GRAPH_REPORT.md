...
## Corpus Check
- 226 files · ~171,085 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3188 nodes · 3067 edges · 263 communities (257 shown, 6 thin omitted)
...
## Communities (263 total, 6 thin omitted)
...
## Knowledge Gaps
- **2424 isolated node(s):** `normalized`, `repoRoot`, `relative`, `res`, `ADR-0006` (+2419 more)
