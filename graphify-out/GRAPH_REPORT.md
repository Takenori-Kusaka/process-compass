...
## Corpus Check
- 114 files · ~83,172 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1076 nodes · 1016 edges · 99 communities (93 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `694bc107`
...
Cohesion: 0.05
Nodes (33): 0. プロセスの概要, 10. 出典一覧, 1. title / purpose / outcomes, 2. 階層構造(process → activities → tasks), 2b. 傘下の主要手法の位置づけ(俯瞰), 3. roles(ロール), 4. information items(成果物・文書), 5. gates(ゲート・決裁) (+25 more)
...
Cohesion: 0.18
Nodes (10): Claude Code 設定(.claude/), Git 戦略, Process Compass, コマンド, プロジェクト構造, プロジェクト運営(Issue 駆動), ライセンス, 執筆規約 (+2 more)
...
## Knowledge Gaps
- **804 isolated node(s):** `normalized`, `res`, `ADR-0006`, `name`, `type` (+799 more)
