...
## Corpus Check
- 255 files · ~172,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3263 nodes · 3168 edges · 276 communities (269 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1181bcc4`
...
## Communities (276 total, 7 thin omitted)
...
Cohesion: 0.13
Nodes (14): Claude Code 設定(.claude/), Git 戦略, graphify, Process Compass, コマンド, プロジェクト構造, プロジェクト運営(Issue 駆動), プロセスの名称(ADR-0027) (+6 more)
...
## Knowledge Gaps
- **2453 isolated node(s):** `プロセスの名称(ADR-0027)`, `プロジェクト構造`, `執筆規約`, `準拠テンプレート(submodule)`, `コマンド` (+2448 more)
