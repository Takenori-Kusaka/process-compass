...
## Corpus Check
- 201 files · ~158,617 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2845 nodes · 2742 edges · 235 communities (229 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0be744f0`
...
## Communities (235 total, 6 thin omitted)
...
## Knowledge Gaps
- **2160 isolated node(s):** `normalized`, `res`, `ADR-0006`, `ADR-0017`, `ADR-0020` (+2155 more)
