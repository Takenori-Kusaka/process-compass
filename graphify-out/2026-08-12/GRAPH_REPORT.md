...
## Corpus Check
- 296 files · ~252,069 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3780 nodes · 3698 edges · 331 communities (324 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `84bc03a3`
...
## Communities (331 total, 7 thin omitted)
...
Cohesion: 0.12
Nodes (16): 0. 要約: この4週間〜3か月で何が変わったか, 10. 出典一覧, 1-1. Anthropic — Mythos クラスの登場と Opus 5, 1-2. Cognition(Devin)— 自社モデル路線と「群」への転換, 1-3. OpenAI — Codex の世代交代と GPT-5.6 ファミリー, 1-4. GitHub Copilot coding agent — 統制設計は維持、範囲は拡大, 1-5. Google — Jules の GA と Gemini 3 系, 1-6. 新興・その他 (+8 more)
...
Cohesion: 0.12
Nodes (17): 0. このメモの位置づけと全体像, 2.1 スクラムガイド 2020 の PO 定義(建前=原典), 2.2 「全員が PO 化する」の意味論(定義からの含意), 2. プロダクトオーナーの本来の責任(スクラムガイド=土台の定義), 3. 前提条件(この編成が暗黙に仮定していること), 4.1 従来のチーム編成との対比(図解の中核: 対比表), 4.2 Amazon の two-pizza team / single-threaded owner(既存の少人数・単一責任論), 4.3 コンウェイの法則との関係 (+9 more)
...
Cohesion: 0.12
Nodes (15): Claude Code 設定(.claude/), Git 戦略, graphify, Process Compass, Zenn 発信(submodule), コマンド, プロジェクト構造, プロジェクト運営(Issue 駆動) (+7 more)
...
### Community 205 - "4. マルチエージェントのトレンド — 「制約された協調+人間の統制」は妥当か"
Cohesion: 0.50
...
### Community 211 - "5. 「人間の検証帯域が律速」— 定量証拠が出そろった"
Cohesion: 0.50
...
Cohesion: 0.12
Nodes (22): applyProcessRules(), buildConfig(), buildRoles(), checkConstraints(), detectDeviations(), detectUnmet(), GATE_BY_KEY, GATE_KEY (+14 more)
...
### Community 234 - "getting-started.md"
Cohesion: 0.12
...
### Community 235 - "solo-developer.md"
Cohesion: 0.12
...
### Community 240 - "build-template-kb.mjs"
Cohesion: 0.18
...
### Community 247 - "accuracy-as-commodity.md"
Cohesion: 0.14
...
### Community 256 - "formatting-intelligence.md"
Cohesion: 0.15
...
### Community 257 - "local-first-privacy.md"
Cohesion: 0.15
...
### Community 258 - "physical-trigger.md"
Cohesion: 0.15
...
### Community 266 - "vault-data-design.md"
Cohesion: 0.17
...
### Community 282 - "speed-floor-gpu-vulkan.md"
Cohesion: 0.20
...
### Community 289 - "default-model-reversal.md"
Cohesion: 0.22
...
### Community 296 - "vendor/tailoring-engine.mjs"
Cohesion: 0.43
...
### Community 299 - "further-reading.md"
Cohesion: 0.29
...
### Community 303 - "guard-write.mjs"
Cohesion: 0.53
Nodes (5): globToRegExp(), main(), match(), readStdin(), ROOT

### Community 304 - "判断記録(ADR)"
Cohesion: 0.33
Nodes (5): コア機能では添付が必須, 判断記録(ADR), 命名, 採用済みの ADR を書き換えない, 書き方

### Community 305 - "template/.github/PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.33
...
### Community 317 - "ProcessOverview.astro"
Cohesion: 0.40
...
### Community 319 - "comparison.astro"
Cohesion: 0.40
...
### Community 322 - "複製したファイル"
Cohesion: 0.40
Nodes (4): なぜ複製するのか, 乖離の検出, 更新の手順, 複製したファイル

### Community 323 - "1. 理想像の出所(建前=そう語られる)"
Cohesion: 0.50
Nodes (4): 1.1 AWS AI-DLC(AI-Driven Development Life Cycle), 1.2 Sean Grove(OpenAI)「The New Code」— 仕様を書く人が最も価値ある programmer, 1.3 「Product Engineer」への収束論(everyone becomes a product owner の実像), 1. 理想像の出所(建前=そう語られる)

### Community 324 - "6. 前版(2026-07-10)との差分"
Cohesion: 0.50
...
### Community 329 - "articles/README.md"
Cohesion: 0.50
...
## Knowledge Gaps
- **2850 isolated node(s):** `normalized`, `repoRoot`, `relative`, `res`, `ADR-0006` (+2845 more)
...
- **Why does `コンテキストエンジニアリング手法 調査メモ` connect `コンテキストエンジニアリング手法 調査メモ` to `20260710-jp-governance.md`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `エージェント型開発の現在地 更新調査メモ(2026-08-04 時点)` connect `エージェント型開発の現在地 更新調査メモ(2026-08-04 時点)` to `20260710-jp-governance.md`, `6. 前版(2026-07-10)との差分`, `4. マルチエージェントのトレンド — 「制約された協調+人間の統制」は妥当か`, `2. ベンチマークの最新値`, `5. 「人間の検証帯域が律速」— 定量証拠が出そろった`?**
