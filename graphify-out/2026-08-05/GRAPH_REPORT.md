...
## Corpus Check
- 136 files · ~91,195 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1312 nodes · 1231 edges · 120 communities (109 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8260f19`
...
### Community 0 - "ハイブリッド開発アンチパターン(なんちゃってアジャイル/ウォーター・スクラム・フォール)調査メモ"
Cohesion: 0.05
...
### Community 15 - "第2部: GitHub Issueドラフト（計12件）"
Cohesion: 0.06
...
### Community 19 - "第1部: 根本課題の構造的整理 (14の論点ノード)"
Cohesion: 0.08
...
### Community 99 - "第2部: GitHub Issueドラフト（計9件）"
Cohesion: 0.09
...
### Community 100 - "🛠️ カテゴリ3: 自動化バイアス・形骸化防止＆メトリクス（ノード9）"
Cohesion: 0.10
...
Cohesion: 0.10
Nodes (20): 0.1 「実装」の定義, 0.2 5つの設計柱（全Issue共通の整合基準）, 0.3 執筆規約（プロジェクト CLAUDE.md 準拠 + 本件追加）, 0.4 Git 運用（オーナー決定 2026-08-05）, 0. 本計画の前提（毎セッション必読）, 1. 作業単位の標準手順（1 Issue あたり／必ずこの順で実行）, 2. 実行順序（8 Wave / 30 Issue）, 3. 成果物マップ（配置先の指針） (+12 more)

### Community 103 - "アジャイル(Agile)調査メモ"
Cohesion: 0.12
...
### Community 104 - "ウォーターフォール開発プロセス 調査メモ"
Cohesion: 0.12
...
## Knowledge Gaps
- **973 isolated node(s):** `normalized`, `res`, `ADR-0006`, `name`, `type` (+968 more)
...
- **Should `ハイブリッド開発アンチパターン(なんちゃってアジャイル/ウォーター・スクラム・フォール)調査メモ` be split into smaller, more focused modules?**
