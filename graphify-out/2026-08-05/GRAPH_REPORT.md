...
## Corpus Check
- 158 files · ~126,435 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2073 nodes · 1970 edges · 175 communities (163 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e2a06900`
...
Cohesion: 0.06
Nodes (32): 5.1 本章が達成すべき成果, 5.2 責任の原則, 5.3 役割境界の時点表記, 5.4.1 レベルを定義する3変数, 5.4.2 3つのレベル, 5.4.3 レベルによらない不変条件, 5.4.4 リスク区分による上限, 5.4.5 レベルの引き上げ (+24 more)
...
### Community 149 - "🛠️ カテゴリ3: 自動化バイアス・形骸化防止＆メトリクス（ノード9）"
Cohesion: 0.10
...
### Community 160 - "block2_research.md"
Cohesion: 0.13
...
### Community 161 - "block3_research.md"
Cohesion: 0.17
...
### Community 162 - "2. 議論から得られた5つの核心的設計方針（To-Be）"
Cohesion: 0.17
