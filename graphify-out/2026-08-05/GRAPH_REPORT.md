...
## Corpus Check
- 134 files · ~90,657 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1291 nodes · 1212 edges · 118 communities (107 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `951578c2`
...
### Community 107 - "block3_research.md"
Cohesion: 0.17
...
### Community 108 - "2. 議論から得られた5つの核心的設計方針（To-Be）"
Cohesion: 0.17
...
## Knowledge Gaps
- **957 isolated node(s):** `normalized`, `res`, `ADR-0006`, `name`, `type` (+952 more)
