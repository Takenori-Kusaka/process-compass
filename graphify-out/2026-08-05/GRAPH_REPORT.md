...
## Corpus Check
- 140 files · ~93,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1353 nodes · 1268 edges · 124 communities (112 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b59dd231`
...
### Community 0 - "第2部: GitHub Issueドラフト（計12件）"
Cohesion: 0.06
...
Cohesion: 0.14
Nodes (13): G-1 企画承認(事業決裁者・既存規程どおり), G-2 要件合意(価値責任者・48時間), G-3 技術設計判断(技術判断者・48時間), G-4 機能仕様承認(価値責任者または委譲先・24時間), G-5 自動検証 CI(機械判定・即時), G-6 独立レビュー(独立レビュア・2営業日), G-7 出荷判定(QA・3営業日), G-8 リリース決裁(事業決裁者・48時間) (+5 more)
...
### Community 113 - "block3_research.md"
Cohesion: 0.17
...
### Community 118 - "2. 議論から得られた5つの核心的設計方針（To-Be）"
Cohesion: 0.17
...
## Knowledge Gaps
- **1000 isolated node(s):** `normalized`, `res`, `ADR-0006`, `name`, `type` (+995 more)
...
- **Why does `AIDLC(AI-Driven Development Life Cycle)調査メモ` connect `AIDLC(AI-Driven Development Life Cycle)調査メモ` to `アジャイル(Agile)調査メモ`?**
...
- **Should `第2部: GitHub Issueドラフト（計12件）` be split into smaller, more focused modules?**
