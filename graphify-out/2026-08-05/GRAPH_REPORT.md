...
## Corpus Check
- 163 files · ~131,005 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2188 nodes · 2080 edges · 181 communities (170 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30d6999f`
...
### Community 135 - "第1部: 根本課題の構造的整理 (14の論点ノード)"
Cohesion: 0.08
...
### Community 166 - "block3_research.md"
Cohesion: 0.17
...
### Community 169 - "2. 議論から得られた5つの核心的設計方針（To-Be）"
Cohesion: 0.17
...
### Community 170 - "1. 自律コーディングエージェントの主要実装例"
Cohesion: 0.25
...
### Community 172 - "4. 限界と課題(現実の到達点の裏面)"
Cohesion: 0.29
...
### Community 175 - "3. 到達点(定量): ベンチマークと実運用のギャップ"
Cohesion: 0.50
...
## Knowledge Gaps
- **1645 isolated node(s):** `normalized`, `res`, `ADR-0006`, `name`, `type` (+1640 more)
...
- **Why does `エージェント型開発(自律・マルチエージェント)の現在地 調査メモ` connect `エージェント型開発(自律・マルチエージェント)の現在地 調査メモ` to `20260710-jp-governance.md`, `1. 自律コーディングエージェントの主要実装例`, `4. 限界と課題(現実の到達点の裏面)`, `3. 到達点(定量): ベンチマークと実運用のギャップ`?**
