...
**分類の語彙は第5章の AI自律レベル L1〜L3 を用います**。本ページ独自の分類記号は設けません。以前の版では「AI置き換え / AI支援 / 人が担保」という独自の3分類を用いていましたが、規定側と語彙が分かれた結果、両者の記述が食い違いました([ADR-0015](/process-compass/adr/0015-role-boundary-by-function-stage/))。
...
:::note
以前の版では判断基準に「可逆性」を含めていましたが、これは[リスク区分 R1〜R3](/process-compass/phase4-process-design/roles-responsibilities/)が「決定の取り消し可能性と影響範囲」として既に定義しています。二重に管理しないため、本ページからは外しました。
:::
