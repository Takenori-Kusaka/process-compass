---
title: 附属書D 導入提案書の様式
description: 本プロセス標準を社内の品質保証部門・プロセス部門へ提案し承認を得るための提案書様式と、提案の進め方
sidebar:
  order: 23
---
...
品質管理部門への提案で最も効くのは、**何を変えないかを最初に示す**ことです。ピットイン方式は既存制度(稟議・決裁権限規程・出荷判定・第三者レビュー)を壊さない設計なので、提案書もその順で構成します。
