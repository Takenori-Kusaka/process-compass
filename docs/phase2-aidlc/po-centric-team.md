...
本ページの整理は **2026-07-10 時点**のものです。とくに「実装コストの限界的ゼロ化」の到達度は、[エージェント型開発の現在地](/process-compass/phase2-aidlc/agentic-development/)(基準日つき)を参照してください。役割の分担に関する本プロジェクトの規定は、[フェーズ3のロール別整理](/process-compass/phase3-gap-analysis/role-mapping/)と[第5章](/process-compass/phase4-process-design/human-ai-boundary/)にあります。
:::
