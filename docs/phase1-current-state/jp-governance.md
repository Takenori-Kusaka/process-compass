...
:::caution
**上図の DR-0 / DR-1 / DR-2 は説明のための例であり、標準化された番号体系ではありません**。DR の実施回数とタイミングは各社が設定するものです。2026-08-06 時点で、DR1〜DR4 のような番号体系を裏づける一次情報は確認できていません。**二次解説どうしを突き合わせると、DR1 の指す工程が食い違います**([調査記録](/process-compass/phase1-current-state/workforce-mobility/))。規格が求めるのは設計・開発のレビューという**活動**であって、番号の付いた段階の集合ではありません。
:::
